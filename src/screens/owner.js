...
export function viewOwnerPanel() {
  ...
  return `<div class="pane">
    ...
    <div class="row" ${act('openGymPresence')}><div class="row__body"><div class="row__title">Presencia en el gym</div><div class="row__meta">Quién está adentro ahora, en vivo</div></div><div class="row__action">${iconSpan('chevronRight', 16)}</div></div>
