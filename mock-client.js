...
(function () {
  ...
  // ---- Fight Club Training Engine, Fase 4 (20260918000000_training_engine_
  // exercise_metadata.sql del lado real) — metadatos que consume el motor,
  // fusionados por nombre, + las 26 filas nuevas de la planilla del dueño.
  // Generado por scratchpad/gen_fase4.cjs desde docs/exercise_metadata_source.md.
  const EXERCISE_ENGINE_META = {
  "Press de banca con barra": { movement_pattern: "empuje_horizontal", secondary_muscles: ["tríceps","deltoides anterior"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["barra","banco"] },
  "Press inclinado con barra": { movement_pattern: "empuje_horizontal_inclinado", secondary_muscles: ["tríceps","deltoides anterior"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["barra","banco"] },
  "Press declinado con barra": { muscle_group: "Pecho", equipment_name: "Barra + banco", level: "Intermedio", goal: "Hipertrofia", kind: "Compuesto", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "empuje_horizontal_declinado", secondary_muscles: ["tríceps","deltoides anterior"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["barra","banco"], _new: true },
  "Press de banca con mancuernas": { movement_pattern: "empuje_horizontal", secondary_muscles: ["tríceps","deltoides anterior"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["mancuernas","banco"] },
  "Press inclinado con mancuernas": { movement_pattern: "empuje_horizontal_inclinado", secondary_muscles: ["tríceps","deltoides anterior"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["mancuernas","banco"] },
  "Aperturas con mancuernas": { movement_pattern: "aduccion_horizontal", secondary_muscles: ["deltoides anterior"], contraindicated_joints: ["hombro","codo"], is_unilateral: false, required_equipment: ["mancuernas","banco"] },
  "Cruce de poleas": { movement_pattern: "aduccion_horizontal", secondary_muscles: ["deltoides anterior"], contraindicated_joints: ["hombro","codo"], is_unilateral: false, required_equipment: ["polea"] },
  "Fondos en paralelas": { movement_pattern: "empuje_vertical", secondary_muscles: ["tríceps","deltoides anterior"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["barra_fija"] },
  "Flexiones": { movement_pattern: "empuje_horizontal", secondary_muscles: ["tríceps","deltoides anterior","core"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Press en máquina": { movement_pattern: "empuje_horizontal", secondary_muscles: ["tríceps","deltoides anterior"], contraindicated_joints: ["hombro","codo"], is_unilateral: false, required_equipment: ["maquina"] },
  "Dominadas": { movement_pattern: "traccion_vertical", secondary_muscles: ["bíceps","redondo mayor","romboides"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["barra_fija","barra"] },
  "Dominadas asistidas": { movement_pattern: "traccion_vertical", secondary_muscles: ["bíceps","romboides"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["maquina_asistida"] },
  "Jalón al pecho": { movement_pattern: "traccion_vertical", secondary_muscles: ["bíceps","romboides"], contraindicated_joints: ["hombro","codo"], is_unilateral: false, required_equipment: ["polea"] },
  "Remo con barra": { movement_pattern: "traccion_horizontal", secondary_muscles: ["romboides","trapecio","bíceps"], contraindicated_joints: ["columna_lumbar","hombro","codo"], is_unilateral: false, required_equipment: ["barra"] },
  "Remo con mancuerna": { movement_pattern: "traccion_horizontal", secondary_muscles: ["romboides","trapecio","bíceps"], contraindicated_joints: ["columna_lumbar","hombro","codo"], is_unilateral: true, required_equipment: ["mancuernas"] },
  "Remo sentado en polea": { movement_pattern: "traccion_horizontal", secondary_muscles: ["romboides","trapecio","bíceps"], contraindicated_joints: ["hombro","codo","columna_lumbar"], is_unilateral: false, required_equipment: ["polea"] },
  "Remo en máquina": { movement_pattern: "traccion_horizontal", secondary_muscles: ["romboides","trapecio","bíceps"], contraindicated_joints: ["hombro","codo"], is_unilateral: false, required_equipment: ["maquina"] },
  "Pullover en polea": { movement_pattern: "extension_hombro", secondary_muscles: ["redondo mayor","tríceps largo"], contraindicated_joints: ["hombro","codo"], is_unilateral: false, required_equipment: ["polea"] },
  "Peso muerto convencional": { muscle_group: "Espalda", equipment_name: "Barra", level: "Avanzado", goal: "Fuerza/Hipertrofia", kind: "Compuesto", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "bisagra_cadera", secondary_muscles: ["glúteos","isquiotibiales","trapecio","core"], contraindicated_joints: ["columna_lumbar","cadera","rodilla"], is_unilateral: false, required_equipment: ["barra"], _new: true },
  "Peso muerto rumano": { movement_pattern: "bisagra_cadera", secondary_muscles: ["glúteos","erectores espinales"], contraindicated_joints: ["columna_lumbar","cadera","rodilla"], is_unilateral: false, required_equipment: ["barra"] },
  "Press militar con barra": { movement_pattern: "empuje_vertical", secondary_muscles: ["tríceps","deltoides lateral"], contraindicated_joints: ["hombro","codo","muñeca","columna_lumbar"], is_unilateral: false, required_equipment: ["barra"] },
  "Press de hombros con mancuernas": { movement_pattern: "empuje_vertical", secondary_muscles: ["tríceps","deltoides lateral"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["mancuernas"] },
  "Press Arnold": { muscle_group: "Hombros", equipment_name: "Mancuernas", level: "Intermedio", goal: "Hipertrofia", kind: "Compuesto", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "empuje_vertical", secondary_muscles: ["deltoides lateral","tríceps"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["mancuernas"], _new: true },
  "Elevaciones laterales": { movement_pattern: "abduccion_hombro", secondary_muscles: ["trapecio superior"], contraindicated_joints: ["hombro","codo"], is_unilateral: false, required_equipment: ["mancuernas"] },
  "Elevaciones laterales en polea": { movement_pattern: "abduccion_hombro", secondary_muscles: ["trapecio superior"], contraindicated_joints: ["hombro","codo"], is_unilateral: true, required_equipment: ["polea"] },
  "Pájaros con mancuernas": { movement_pattern: "abduccion_horizontal", secondary_muscles: ["romboides","trapecio"], contraindicated_joints: ["hombro","codo"], is_unilateral: false, required_equipment: ["mancuernas"] },
  "Face pull": { movement_pattern: "rotacion_externa", secondary_muscles: ["trapecio","romboides"], contraindicated_joints: ["hombro","codo"], is_unilateral: false, required_equipment: ["polea","cuerda_saltar"] },
  "Elevación frontal": { muscle_group: "Hombros", equipment_name: "Mancuernas", level: "Principiante", goal: "Hipertrofia", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "flexion_hombro", secondary_muscles: ["pectoral superior"], contraindicated_joints: ["hombro","codo"], is_unilateral: false, required_equipment: ["mancuernas"], _new: true },
  "Curl de bíceps con barra": { movement_pattern: "flexion_codo", secondary_muscles: ["braquial","braquiorradial"], contraindicated_joints: ["codo","muñeca"], is_unilateral: false, required_equipment: ["barra"] },
  "Curl con mancuernas": { muscle_group: "Bíceps", equipment_name: "Mancuernas", level: "Principiante", goal: "Hipertrofia", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "flexion_codo", secondary_muscles: ["braquial","braquiorradial"], contraindicated_joints: ["codo","muñeca"], is_unilateral: false, required_equipment: ["mancuernas"], _new: true },
  "Curl alterno con mancuernas": { movement_pattern: "flexion_codo", secondary_muscles: ["braquial","braquiorradial"], contraindicated_joints: ["codo","muñeca"], is_unilateral: true, required_equipment: ["mancuernas"] },
  "Curl martillo": { movement_pattern: "flexion_codo", secondary_muscles: ["bíceps","braquiorradial"], contraindicated_joints: ["codo","muñeca"], is_unilateral: false, required_equipment: ["mancuernas"] },
  "Curl predicador": { movement_pattern: "flexion_codo", secondary_muscles: ["braquial"], contraindicated_joints: ["codo","muñeca"], is_unilateral: false, required_equipment: ["banco_predicador","banco"] },
  "Curl en polea": { movement_pattern: "flexion_codo", secondary_muscles: ["braquial"], contraindicated_joints: ["codo","muñeca"], is_unilateral: false, required_equipment: ["polea"] },
  "Curl concentrado": { muscle_group: "Bíceps", equipment_name: "Mancuerna", level: "Principiante", goal: "Hipertrofia", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "flexion_codo", secondary_muscles: ["braquial"], contraindicated_joints: ["codo","muñeca"], is_unilateral: true, required_equipment: ["mancuernas"], _new: true },
  "Press cerrado": { movement_pattern: "empuje_horizontal", secondary_muscles: ["pectoral","deltoides anterior"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["barra","banco"] },
  "Extensión de tríceps en polea": { movement_pattern: "extension_codo", secondary_muscles: [], contraindicated_joints: ["codo","muñeca"], is_unilateral: false, required_equipment: ["polea","cuerda_saltar"] },
  "Extensión de tríceps sobre cabeza": { movement_pattern: "extension_codo", secondary_muscles: [], contraindicated_joints: ["hombro","codo"], is_unilateral: false, required_equipment: ["mancuernas"] },
  "Press francés": { movement_pattern: "extension_codo", secondary_muscles: [], contraindicated_joints: ["codo","muñeca"], is_unilateral: false, required_equipment: ["barra_ez","banco"] },
  "Fondos para tríceps": { muscle_group: "Tríceps", equipment_name: "Paralelas", level: "Intermedio", goal: "Fuerza/Hipertrofia", kind: "Compuesto", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "empuje_vertical", secondary_muscles: ["pectoral","deltoides anterior"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["barra_fija"], _new: true },
  "Patada de tríceps": { movement_pattern: "extension_codo", secondary_muscles: [], contraindicated_joints: ["codo","hombro"], is_unilateral: true, required_equipment: ["mancuernas"] },
  "Sentadilla con barra": { movement_pattern: "sentadilla", secondary_muscles: ["glúteos","isquiotibiales","core"], contraindicated_joints: ["rodilla","cadera","tobillo","columna_lumbar"], is_unilateral: false, required_equipment: ["barra"] },
  "Sentadilla frontal": { movement_pattern: "sentadilla", secondary_muscles: ["glúteos","core"], contraindicated_joints: ["rodilla","cadera","tobillo","muñeca"], is_unilateral: false, required_equipment: ["barra"] },
  "Prensa de piernas": { movement_pattern: "empuje_pierna", secondary_muscles: ["glúteos","isquiotibiales"], contraindicated_joints: ["rodilla","cadera","tobillo"], is_unilateral: false, required_equipment: ["prensa"] },
  "Zancadas caminando": { movement_pattern: "zancada", secondary_muscles: ["glúteos","isquiotibiales"], contraindicated_joints: ["rodilla","cadera","tobillo"], is_unilateral: true, required_equipment: ["mancuernas"] },
  "Split squat búlgaro": { movement_pattern: "zancada", secondary_muscles: ["glúteos","isquiotibiales"], contraindicated_joints: ["rodilla","cadera","tobillo"], is_unilateral: true, required_equipment: ["mancuernas"] },
  "Extensión de piernas": { movement_pattern: "extension_rodilla", secondary_muscles: [], contraindicated_joints: ["rodilla"], is_unilateral: false, required_equipment: ["maquina"] },
  "Curl femoral tumbado": { movement_pattern: "flexion_rodilla", secondary_muscles: ["gemelos"], contraindicated_joints: ["rodilla","cadera"], is_unilateral: false, required_equipment: ["maquina"] },
  "Curl femoral sentado": { movement_pattern: "flexion_rodilla", secondary_muscles: ["gemelos"], contraindicated_joints: ["rodilla","cadera"], is_unilateral: false, required_equipment: ["maquina"] },
  "Peso muerto con mancuernas": { movement_pattern: "bisagra_cadera", secondary_muscles: ["glúteos","erectores espinales"], contraindicated_joints: ["columna_lumbar","cadera","rodilla"], is_unilateral: false, required_equipment: ["mancuernas"] },
  "Sentadilla sumo": { muscle_group: "Piernas", equipment_name: "Barra", level: "Principiante", goal: "Hipertrofia", kind: "Compuesto", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "sentadilla", secondary_muscles: ["glúteos","cuádriceps","isquiotibiales"], contraindicated_joints: ["cadera","rodilla","tobillo"], is_unilateral: false, required_equipment: ["barra"], _new: true },
  "Step-up": { movement_pattern: "zancada", secondary_muscles: ["glúteos","isquiotibiales"], contraindicated_joints: ["rodilla","cadera","tobillo"], is_unilateral: true, required_equipment: ["mancuernas","banco"] },
  "Sentadilla hack": { movement_pattern: "sentadilla", secondary_muscles: ["glúteos"], contraindicated_joints: ["rodilla","cadera","tobillo"], is_unilateral: false, required_equipment: ["maquina_hack"] },
  "Buenos días con barra": { muscle_group: "Piernas", equipment_name: "Barra", level: "Avanzado", goal: "Fuerza", kind: "Compuesto", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "bisagra_cadera", secondary_muscles: ["glúteos","erectores espinales"], contraindicated_joints: ["columna_lumbar","cadera"], is_unilateral: false, required_equipment: ["barra"], _new: true },
  "Extensión de cadera en máquina": { muscle_group: "Glúteos", equipment_name: "Máquina", level: "Principiante", goal: "Hipertrofia", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "extension_cadera", secondary_muscles: ["isquiotibiales"], contraindicated_joints: ["cadera","columna_lumbar"], is_unilateral: false, required_equipment: ["maquina"], _new: true },
  "Hip thrust con barra": { movement_pattern: "extension_cadera", secondary_muscles: ["isquiotibiales","aductores"], contraindicated_joints: ["cadera","columna_lumbar"], is_unilateral: false, required_equipment: ["barra"] },
  "Puente de glúteos": { movement_pattern: "extension_cadera", secondary_muscles: ["isquiotibiales"], contraindicated_joints: ["cadera","columna_lumbar"], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Patada de glúteo en polea": { muscle_group: "Glúteos", equipment_name: "Polea", level: "Principiante", goal: "Hipertrofia", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "extension_cadera", secondary_muscles: ["isquiotibiales"], contraindicated_joints: ["cadera","columna_lumbar"], is_unilateral: true, required_equipment: ["polea"], _new: true },
  "Abducción de cadera": { movement_pattern: "abduccion_cadera", secondary_muscles: ["glúteo menor"], contraindicated_joints: ["cadera"], is_unilateral: false, required_equipment: ["maquina"] },
  "Abducción de cadera en polea": { muscle_group: "Glúteos", equipment_name: "Polea", level: "Principiante", goal: "Hipertrofia", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "abduccion_cadera", secondary_muscles: ["glúteo menor"], contraindicated_joints: ["cadera"], is_unilateral: true, required_equipment: ["polea"], _new: true },
  "Elevación de talones de pie": { movement_pattern: "flexion_plantar", secondary_muscles: ["sóleo"], contraindicated_joints: ["tobillo","rodilla"], is_unilateral: false, required_equipment: ["maquina"] },
  "Elevación de talones sentado": { movement_pattern: "flexion_plantar", secondary_muscles: ["gastrocnemio"], contraindicated_joints: ["tobillo","rodilla"], is_unilateral: false, required_equipment: ["maquina"] },
  "Elevación de talones en prensa": { muscle_group: "Pantorrillas", equipment_name: "Prensa", level: "Principiante", goal: "Hipertrofia", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "flexion_plantar", secondary_muscles: ["sóleo"], contraindicated_joints: ["tobillo","rodilla"], is_unilateral: false, required_equipment: ["prensa"], _new: true },
  "Elevación unilateral de talones": { muscle_group: "Pantorrillas", equipment_name: "Peso corporal", level: "Principiante", goal: "Hipertrofia", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "flexion_plantar", secondary_muscles: ["sóleo"], contraindicated_joints: ["tobillo","rodilla"], is_unilateral: true, required_equipment: ["peso_corporal"], _new: true },
  "Crunch": { movement_pattern: "flexion_tronco", secondary_muscles: ["oblicuos"], contraindicated_joints: ["columna_cervical","columna_lumbar"], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Crunch en polea": { movement_pattern: "flexion_tronco", secondary_muscles: ["oblicuos"], contraindicated_joints: ["columna_lumbar"], is_unilateral: false, required_equipment: ["polea"] },
  "Elevación de piernas": { movement_pattern: "flexion_cadera", secondary_muscles: ["flexores de cadera"], contraindicated_joints: ["cadera","columna_lumbar"], is_unilateral: false, required_equipment: ["barra_fija","barra"] },
  "Elevación de rodillas": { movement_pattern: "flexion_cadera", secondary_muscles: ["flexores de cadera"], contraindicated_joints: ["cadera","columna_lumbar"], is_unilateral: false, required_equipment: ["barra_fija","barra"] },
  "Plancha": { movement_pattern: "isometrico", secondary_muscles: ["recto abdominal","oblicuos"], contraindicated_joints: ["hombro","columna_lumbar"], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Plancha lateral": { movement_pattern: "isometrico", secondary_muscles: ["core","glúteo medio"], contraindicated_joints: ["hombro","columna_lumbar","cadera"], is_unilateral: true, required_equipment: ["peso_corporal"] },
  "Russian twist": { muscle_group: "Core", equipment_name: "Peso corporal", level: "Intermedio", goal: "Core", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "rotacion_tronco", secondary_muscles: ["recto abdominal"], contraindicated_joints: ["columna_lumbar","cadera"], is_unilateral: false, required_equipment: ["peso_corporal"], _new: true },
  "Pallof press": { muscle_group: "Core", equipment_name: "Polea", level: "Principiante", goal: "Core/Control motor", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "antirotacion", secondary_muscles: ["oblicuos","transverso abdominal"], contraindicated_joints: ["hombro","codo","columna_lumbar"], is_unilateral: false, required_equipment: ["polea"], _new: true },
  "Encogimientos con barra": { muscle_group: "Trapecios", equipment_name: "Barra", level: "Principiante", goal: "Hipertrofia", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "elevacion_escapular", secondary_muscles: ["elevador de la escápula"], contraindicated_joints: ["hombro","cuello"], is_unilateral: false, required_equipment: ["barra"], _new: true },
  "Encogimientos con mancuernas": { movement_pattern: "elevacion_escapular", secondary_muscles: ["elevador de la escápula"], contraindicated_joints: ["hombro","cuello"], is_unilateral: false, required_equipment: ["mancuernas"] },
  "Farmer walk": { movement_pattern: "transporte", secondary_muscles: ["trapecio","core","hombros"], contraindicated_joints: ["hombro","muñeca","columna_lumbar"], is_unilateral: false, required_equipment: ["mancuernas"] },
  "Curl inverso": { muscle_group: "Antebrazos", equipment_name: "Barra", level: "Intermedio", goal: "Hipertrofia", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "flexion_codo", secondary_muscles: ["extensores de muñeca","bíceps"], contraindicated_joints: ["codo","muñeca"], is_unilateral: false, required_equipment: ["barra"], _new: true },
  "Burpees": { movement_pattern: "pliometria", secondary_muscles: ["pecho","piernas","core","hombros"], contraindicated_joints: ["rodilla","tobillo","hombro","muñeca"], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Mountain climbers": { movement_pattern: "cardio_dinamico", secondary_muscles: ["hombros","flexores de cadera","piernas"], contraindicated_joints: ["hombro","muñeca","cadera"], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Jumping jacks": { movement_pattern: "cardio_dinamico", secondary_muscles: ["pantorrillas","hombros"], contraindicated_joints: ["tobillo","rodilla","hombro"], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Cuerda de saltar": { movement_pattern: "saltos", secondary_muscles: ["cuádriceps","core","hombros"], contraindicated_joints: ["tobillo","rodilla","muñeca"], is_unilateral: false, required_equipment: ["cuerda_saltar"] },
  "Sprint en cinta": { movement_pattern: "carrera", secondary_muscles: ["glúteos","core","pantorrillas"], contraindicated_joints: ["rodilla","tobillo","cadera"], is_unilateral: false, required_equipment: ["cinta"] },
  "Caminata inclinada": { movement_pattern: "marcha", secondary_muscles: ["glúteos","pantorrillas"], contraindicated_joints: ["rodilla","tobillo","cadera"], is_unilateral: false, required_equipment: ["cinta"] },
  "Remo al mentón con cable": { muscle_group: "Hombros", equipment_name: "Polea", level: "Intermedio", goal: "Hipertrofia", kind: "Compuesto", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "traccion_vertical", secondary_muscles: ["trapecio","bíceps"], contraindicated_joints: ["hombro","codo","muñeca"], is_unilateral: false, required_equipment: ["polea"], _new: true },
  "Rotación externa con polea": { muscle_group: "Hombros", equipment_name: "Polea", level: "Principiante", goal: "Salud de hombro", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "rotacion_externa", secondary_muscles: ["deltoides posterior"], contraindicated_joints: ["hombro","codo"], is_unilateral: true, required_equipment: ["polea"], _new: true },
  "Rotación interna con polea": { muscle_group: "Hombros", equipment_name: "Polea", level: "Principiante", goal: "Salud de hombro", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "rotacion_interna", secondary_muscles: ["pectoral","dorsal"], contraindicated_joints: ["hombro","codo"], is_unilateral: true, required_equipment: ["polea"], _new: true },
  "Extensión de muñeca": { muscle_group: "Antebrazos", equipment_name: "Mancuerna", level: "Principiante", goal: "Hipertrofia", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "extension_muñeca", secondary_muscles: [], contraindicated_joints: ["muñeca","codo"], is_unilateral: false, required_equipment: ["mancuernas"], _new: true },
  "Flexión de muñeca": { muscle_group: "Antebrazos", equipment_name: "Mancuerna", level: "Principiante", goal: "Hipertrofia", kind: "Aislamiento", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "flexion_muñeca", secondary_muscles: [], contraindicated_joints: ["muñeca","codo"], is_unilateral: false, required_equipment: ["mancuernas"], _new: true },
  "Buenos días con peso corporal": { muscle_group: "Piernas", equipment_name: "Peso corporal", level: "Principiante", goal: "Movilidad/Fuerza", kind: "Compuesto", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "bisagra_cadera", secondary_muscles: ["glúteos","erectores espinales"], contraindicated_joints: ["columna_lumbar","cadera"], is_unilateral: false, required_equipment: ["peso_corporal"], _new: true },
  "Sentadilla con peso corporal": { muscle_group: "Piernas", equipment_name: "Peso corporal", level: "Principiante", goal: "Resistencia", kind: "Compuesto", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "sentadilla", secondary_muscles: ["glúteos","isquiotibiales","core"], contraindicated_joints: ["rodilla","cadera","tobillo"], is_unilateral: false, required_equipment: ["peso_corporal"], _new: true },
  "Zancada con peso corporal": { muscle_group: "Piernas", equipment_name: "Peso corporal", level: "Principiante", goal: "Resistencia", kind: "Unilateral", description: "Ejecuta el movimiento con control, rango cómodo y técnica estable.", suggested_sets: 3, suggested_reps: "8-12", suggested_rest_seconds: 90, movement_pattern: "zancada", secondary_muscles: ["glúteos","isquiotibiales"], contraindicated_joints: ["rodilla","cadera","tobillo"], is_unilateral: true, required_equipment: ["peso_corporal"], _new: true },
  "Sentadilla goblet": { movement_pattern: "sentadilla", secondary_muscles: ["glúteos","core"], contraindicated_joints: ["rodilla","cadera","tobillo"], is_unilateral: false, required_equipment: ["mancuernas"] },
  "Zancada atrás": { movement_pattern: "zancada", secondary_muscles: ["glúteos","isquiotibiales"], contraindicated_joints: ["rodilla","cadera","tobillo"], is_unilateral: true, required_equipment: ["mancuernas"] },
  "Aducción de cadera": { movement_pattern: "aduccion_cadera", secondary_muscles: [], contraindicated_joints: ["cadera"], is_unilateral: false, required_equipment: ["maquina"] },
  "Press de hombros en máquina": { movement_pattern: "empuje_vertical", secondary_muscles: ["tríceps","deltoides lateral"], contraindicated_joints: ["hombro","codo"], is_unilateral: false, required_equipment: ["maquina"] },
  "Dead bug": { movement_pattern: "antirotacion", secondary_muscles: ["transverso abdominal"], contraindicated_joints: ["columna_lumbar"], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Bird dog": { movement_pattern: "antirotacion", secondary_muscles: ["glúteos","erectores espinales"], contraindicated_joints: ["columna_lumbar","hombro"], is_unilateral: true, required_equipment: ["peso_corporal"] },
  "Bicicleta estática": { movement_pattern: "cardio_ciclico", secondary_muscles: ["glúteos","pantorrillas"], contraindicated_joints: ["rodilla"], is_unilateral: false, required_equipment: ["bicicleta"] },
  "Remo ergómetro": { movement_pattern: "cardio_ciclico", secondary_muscles: ["espalda","piernas","core"], contraindicated_joints: ["columna_lumbar","rodilla"], is_unilateral: false, required_equipment: ["remo_ergometro"] },
  "Battle ropes": { movement_pattern: "cardio_dinamico", secondary_muscles: ["hombros","core"], contraindicated_joints: ["hombro"], is_unilateral: false, required_equipment: ["battle_ropes"] },
  "Kettlebell swing": { movement_pattern: "bisagra_cadera", secondary_muscles: ["glúteos","core","hombros"], contraindicated_joints: ["columna_lumbar","cadera","hombro"], is_unilateral: false, required_equipment: ["kettlebell"] },
  "Turkish get-up": { movement_pattern: "explosivo", secondary_muscles: ["core","hombros","piernas"], contraindicated_joints: ["hombro","muñeca","cadera"], is_unilateral: true, required_equipment: ["kettlebell"] },
  "Clean con kettlebell": { movement_pattern: "explosivo", secondary_muscles: ["glúteos","trapecio","core"], contraindicated_joints: ["columna_lumbar","hombro","muñeca"], is_unilateral: false, required_equipment: ["kettlebell"] },
  "Box jump": { movement_pattern: "pliometria", secondary_muscles: ["glúteos","pantorrillas","core"], contraindicated_joints: ["rodilla","tobillo"], is_unilateral: false, required_equipment: ["cajon"] },
  "Lanzamiento de balón medicinal": { movement_pattern: "explosivo", secondary_muscles: ["core","hombros","piernas"], contraindicated_joints: ["hombro","columna_lumbar"], is_unilateral: false, required_equipment: ["balon_medicinal"] },
  "Golpes al saco": { movement_pattern: "boxeo", secondary_muscles: ["hombros","core"], contraindicated_joints: ["hombro","muñeca"], is_unilateral: false, required_equipment: ["saco_boxeo"] },
  "Sombra de boxeo": { movement_pattern: "boxeo", secondary_muscles: ["hombros","core","piernas"], contraindicated_joints: ["hombro"], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Combinación jab-cross": { movement_pattern: "boxeo", secondary_muscles: ["hombros","core"], contraindicated_joints: ["hombro","muñeca"], is_unilateral: false, required_equipment: ["saco_boxeo","guantes"] },
  "Hook al saco": { movement_pattern: "boxeo", secondary_muscles: ["core","hombros"], contraindicated_joints: ["hombro","muñeca"], is_unilateral: false, required_equipment: ["saco_boxeo","guantes"] },
  "Uppercut al saco": { movement_pattern: "boxeo", secondary_muscles: ["core","hombros"], contraindicated_joints: ["hombro","muñeca"], is_unilateral: false, required_equipment: ["saco_boxeo","guantes"] },
  "Burpee + golpe": { movement_pattern: "pliometria", secondary_muscles: ["pecho","piernas","core","hombros"], contraindicated_joints: ["rodilla","tobillo","hombro","muñeca"], is_unilateral: false, required_equipment: ["peso_corporal","saco_boxeo"] },
  "Movilidad de tobillo": { movement_pattern: "movilidad", secondary_muscles: [], contraindicated_joints: [], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Rotación torácica": { movement_pattern: "movilidad", secondary_muscles: [], contraindicated_joints: [], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Estiramiento flexor de cadera": { movement_pattern: "movilidad", secondary_muscles: [], contraindicated_joints: [], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Estiramiento de isquiotibiales": { movement_pattern: "movilidad", secondary_muscles: [], contraindicated_joints: [], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Estiramiento de pectoral": { movement_pattern: "movilidad", secondary_muscles: [], contraindicated_joints: [], is_unilateral: false, required_equipment: ["peso_corporal"] },
  "Estiramiento de dorsal": { movement_pattern: "movilidad", secondary_muscles: [], contraindicated_joints: [], is_unilateral: false, required_equipment: ["banco"] },
  };
  db.exercises.filter(e => e.gym_id === null).forEach(e => { e.is_active = true; });
  for (const [engName, engMeta] of Object.entries(EXERCISE_ENGINE_META)) {
    if (engMeta._new) {
      const { _new, ...fields } = engMeta;
      db.exercises.push({ id: uid('ex'), gym_id: null, media_key: null, name: engName, is_active: true, ...fields });
    } else {
      const engRow = db.exercises.find(e => e.gym_id === null && e.name === engName);
      if (engRow) Object.assign(engRow, engMeta);
    }
  }
    ...
    async list(gymId) {
      ...
      return db.exercises.filter(e => e.gym_id === null || e.gym_id === gymId)
        .map(e => ({
          ...
          movementPattern: e.movement_pattern, secondaryMuscles: e.secondary_muscles || [], contraindicatedJoints: e.contraindicated_joints || [],
          isUnilateral: !!e.is_unilateral, isActive: e.is_active !== false, requiredEquipment: e.required_equipment || [],
        }));
    },
